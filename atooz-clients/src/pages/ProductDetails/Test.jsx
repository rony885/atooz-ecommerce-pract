...
import bannerImg1 from "../../images/categoryImg-1.jpg";
import bannerImg2 from "../../images/categoryImg-4.jpg";
import bannerImg3 from "../../images/categoryImg-2.jpg";
import tshirtBannerImg from "../../images/tShirtBannerR-img.jpg";
import { Link } from "react-router-dom";

const SingleProductDetails = () => {
  const [activeItem, setActiveItem] = React.useState("one");
          ...
          <div className="product_content">
            <div className="">
              <h2 className="fs-3 text-start">
                All Products Combo <small className="fs-6">(15 avaiable)</small>
              </h2>
              <h2 className="mb-3 text-start">Product Id:33.01.200.1214</h2>
            </div>
            ...
            <div className="d-flex justify-content-start align-items-start gap-2 flexxCC">
              ...
              <div className="d-flex justify-content-start align-items-center gap-2">
                <h5 className="fs-6">152 Ratings</h5>
                <div
                  style={{
                    height: "14px",
                    width: "1px",
                  ...
                  className="mb-0"
                ></div>
                <h5 className="fs-6">7 Reviews</h5>
              </div>
            </div>
                    ...
                    <li>
                      <div className="">
                        <h5 className="fs-6 text-justify">
                          ...
                          elit. Error, exercitationem! Lorem ipsum dolor sit
                          amet consectetur adipisicing elit. Error,
                          exercitationem! Lorem ipsum dolor sit amet consectetur
                          adipisicing elit. Error, exercitationem! Lorem ipsum
